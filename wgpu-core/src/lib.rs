pub(crate) mod device {
    ...
    pub(crate) mod global {
        ...
        use crate::id::{self};
        use crate::identity::GlobalIdentityHandlerFactory;
    ...
    pub(crate) mod resource {
        ...
        use crate::device::MissingFeatures;
...
pub(crate) mod registry {
    use wgpu_hal::wgt::Backend;
    use crate::hub::Access;
    use crate::hub::Token;
    use crate::id;
    use crate::identity::IdentityHandler;
    use crate::identity::IdentityHandlerFactory;
    ...
    impl<I: id::TypedId + Copy, T> FutureId<'_, I, T> {
        ...
        pub(crate) fn assign_error<'a, A: Access<T>>(self, _label: &str, _: &'a mut Token<A>) -> I {
            unimplemented!()
        }
    }
